...
class AITutor:
    ...
    def run_socratic_dialogue(
        ...
        elif "直感" in tutor_style:
            style_instruction = (
                "- 専門用語や数式を極力減らし、身近な例え話（メタファー）を用いて直感的にわかりやすく回答してください。\n"
                "- ユーザーがイメージしやすいように、親しみやすい口調で直接的に答えを教えてください。\n"
            )
        elif "厳密" in tutor_style:
            style_instruction = (
                "- 定義、定理、数式展開を用いて、学術的に極めて厳密に回答してください。\n"
                "- 曖昧な表現を排除し、専門用語を正確に使用して直接的に解説してください。\n"
            )
        else:
            style_instruction = (
                "- 理論と具体例をバランス良く交えて、大学の講義のようにわかりやすく直接的に回答してください。\n"
            )
        ...
        system_prompt: str = (
            ...
            "【行動原則】\n"
            f"{style_instruction}"
            "- ユーザーの誤解や不正確な理解を発見したら、優しく修正してください。\n"
    ...
    def generate_lecture(
        ...
        # スタイルに応じた補足をプロンプト末尾に注入
        if "直感" in tutor_style:
            lecture_system_prompt += (
                "- 【解説スタイル】: 数式を極力減らし、初学者が直感的に理解できるよう、"
                "具体的な比喩や例え話を豊富に交えて解説してください。\n"
            )
        elif "厳密" in tutor_style:
            lecture_system_prompt += (
